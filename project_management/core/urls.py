...
urlpatterns = [
    ...
    path("tasks/archived/", views_tasks.archived_tasks_view, name="archived_tasks"),
    path("tasks/overview/", views_tasks.tasks_overview_view, name="tasks_overview"),
    path("tasks/overview/export-excel/", views_tasks.export_tasks_excel, name="export_tasks_excel"),
    path("tasks/overview/metric/export-excel/", views_tasks.export_metric_drilldown_excel, name="export_metric_drilldown_excel"),
    path("tasks/overview/metric/<str:metric_key>/", views_tasks.metric_drilldown_view, name="metric_drilldown"),
    ...
    path("tasks/bulk-import/download-template/", views_tasks.download_excel_template, name="download_excel_template"),
    ...
    path("tasks/<int:task_id>/archive/", views_tasks.archive_task_view, name="archive_task"),
    path("tasks/<int:task_id>/restore/", views_tasks.restore_task_view, name="restore_task"),
